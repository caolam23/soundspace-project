...
function UserHomePage() {
    ...
    // ==============================
    // HANDLE CREATE ROOM (CÓ REDIRECT)
    // ==============================
    const handleCreateRoom = async (e) => {
        ...
        try {
            ...
            // === Quan trọng: redirect Host vào phòng ngay sau khi tạo ===
    ...
    // ==============================
    useEffect(() => {
        // Intentionally not registering 'new-join-request' here to avoid duplicate host prompts.
        // RoomPage handles join requests UI when the host is inside the room.
        if (!socket) return;
    }, [socket, navigate]);
            ...
            <header className="user-page-header">
                <div className="header-container">
                    ...
                    <button 
                        ...
                        className="create-room-button-header"
                    >
                    ...
                    <div className="create-room-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleCreateRoom} className="create-room-form">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="text" id="roomName" name="name"
                                    className="form-control" placeholder="Ví dụ: Đêm nhạc Lofi & Chill"
                                    value={roomData.name} onChange={handleInputChange} required
                                />
                            </div>
                            <div className="form-group">
                                <label htmlFor="roomDescription">Mô tả ngắn</label>
                                <textarea
                                    id="roomDescription" name="description"
                                    className="form-control" placeholder="Giới thiệu về phòng của bạn..."
                                    value={roomData.description} onChange={handleInputChange}
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <div className="privacy-options">
                                    ...
                                    <label className="privacy-option">
                                        <input type="radio" name="privacy" value="manual"
